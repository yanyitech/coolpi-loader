...
CROSS_COMPILE_ARM32=./toolchain/bin/arm-linux-gnueabihf-
CROSS_COMPILE_ARM64=./toolchain/bin/aarch64-none-linux-gnu-
########################################### User not touch #############################################
...
function help()
{
	...
	echo
	echo "Output:"
	echo "	 When board built okay, there are uboot images in current directory"
	echo
	echo "Example:"
	echo
	echo "1. Build:"
	echo "	./make.sh rk3588s_cp4b             --- build for rk3588s_cp4b_defconfig"
}
